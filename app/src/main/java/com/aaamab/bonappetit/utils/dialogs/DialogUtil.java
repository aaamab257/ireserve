package com.aaamab.bonappetit.utils.dialogs;
...
//    }
    ...
    public void showDialogDatePicker(final Context context, int type) {
    ...
    DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear,
            ...
            //  updateLabel();
            dateresponse.DateFormatResponse(myCalendar, type);
        }
    };
    ...
    public void showDialogWithMultiChoiceskills(final Context context, @StringRes int title,
                                                @StringRes int okButtonText, final ArrayList<String> listarray,
                                                final String arrayType, final ArrayList<Integer> ids) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(context, R.style.AlertDialogCustom));
        //AlertDialog.Builder builder = new AlertDialog.Builder(context);
